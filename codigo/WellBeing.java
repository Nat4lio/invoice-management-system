/**
 * A classe WellBeing representa um produto que não necessita de prescrição.
 * Esta classe herda da classe WithouthPrescription.
 */
public class WellBeing extends WithouthPrescription 
{
    /**
     * Construtor padrão da classe WellBeing.
     */
    public WellBeing() 
    {
        super();
    ...
    /**
     * Construtor da classe WellBeing com parâmetros.
     *
     ...
     */
    public WellBeing(String code, String name, String description, int quantity, double unitPrice, boolean prescription, String category) 
    {
    ...
    /**
     * Retorna uma representação em string do objeto WellBeing.
     *
     * @return Uma string representando o objeto WellBeing.
     */
    @Override
