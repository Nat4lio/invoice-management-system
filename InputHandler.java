...
/**
 * A classe InputHandler lida com a entrada de dados do usuário.
 */
public class InputHandler
{
    ...
    /**
     * Construtor padrão da classe InputHandler.
     * Inicializa o scanner para entrada de dados do sistema padrão.
     */
    public InputHandler() 
    {
    ...
    /**
     * Construtor da classe InputHandler com um Scanner personalizado.
     *
    ...
    /**
     * Solicita ao usuário a entrada de um nome.
     *
     * @param prompt A mensagem a ser exibida ao solicitar a entrada.
     * @return O nome inserido pelo usuário.
     * @throws IllegalArgumentException Se o nome inserido for inválido.
     */
