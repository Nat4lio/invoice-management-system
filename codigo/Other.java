/**
 * A classe Other representa um produto que não necessita de prescrição.
 * Esta classe herda da classe WithouthPrescription.
 */
public class Other extends WithouthPrescription 
{
    /**
     * Construtor padrão da classe Other.
     */
    public Other() 
    {
        super();
    ...
    /**
     * Construtor da classe Other com parâmetros.
     *
     ...
     */
    public Other(String code, String name, String description, int quantity, double unitPrice, boolean prescription, String category) {
    ...
    /**
     * Retorna uma representação em string do objeto Other.
     *
     * @return Uma string representando o objeto Other.
     */
    @Override
