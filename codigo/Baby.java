/**
 * A classe Baby representa um produto que não necessita de prescrição.
 * Esta classe herda da classe WithouthPrescription.
 */
public class Baby extends WithouthPrescription 
{
    /**
     * Construtor padrão da classe Baby.
     */
    public Baby() 
    {
        super();
    ...
    /**
     * Construtor da classe Baby com parâmetros.
     *
     ...
     */
    public Baby(String code, String name, String description, int quantity, double unitPrice,
    ...
    /**
     * Retorna uma representação em string do objeto Baby.
     *
     * @return Uma string representando o objeto Baby.
     */
    @Override
